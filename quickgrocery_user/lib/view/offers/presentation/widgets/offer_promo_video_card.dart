...
///
/// The **entire card** (media, badge, title, CTA) navigates via
/// [navigateFromOffer] so product redirects always open Product Details.
...
class _OfferPromoVideoCardState extends ConsumerState<OfferPromoVideoCard> {
  ...
  Future<void> _open() async {
    ...
    try {
      await navigateFromOffer(context, ref, widget.offer);
    } finally {
          ...
          child: SizedBox(
            ...
            child: Stack(
              ...
              children: [
                ...
                // Video/image must not steal taps from the card InkWell.
                IgnorePointer(
                    ...
                    children: [
                      ...
                      FilledButton(
                        style: FilledButton.styleFrom(
                          backgroundColor:
                              AppSurface.of(context).card.withValues(alpha: 0.95),
                        ...
                        child: Text(
                          widget.offer.ctaText.trim().isEmpty
                              ? 'Shop now'
