...
class KeyboardSafeBody extends StatelessWidget {
  ...
  /// When true, content is at least viewport-tall (replaces [Spacer] layouts).
  final bool fillMinHeight;

  /// Centers [child] vertically when [fillMinHeight] is true.
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final minHeight = fillMinHeight
            ? (constraints.maxHeight - viewInsets.bottom).clamp(0.0, double.infinity)
            : 0.0;
