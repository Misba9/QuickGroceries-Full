...
import 'package:quick_grocery_admin/view/sms/services/notification_access_config.dart';

/// Resolves whether the signed-in user may use the Notifications / SMS panel.
///
...
Future<bool> currentUserCanManageSms({bool forceRefresh = true}) async {
