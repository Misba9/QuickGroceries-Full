...
class AllOrdersScreeen extends StatefulWidget {
  const AllOrdersScreeen({super.key});

  @override
  State<AllOrdersScreeen> createState() => _AllOrdersScreeenState();
}

class _AllOrdersScreeenState extends State<AllOrdersScreeen> {
  @override
  void initState() {
                ...
                children: [
                  ...
                  provider.orders == null
                      ...
                      : DataTable(
                          ...
                          rows: List.generate(provider.orders!.length, (index) {
                            return DataRow(
                              cells: [
                                DataCell(Text((index + 1).toString())),
                                DataCell(Text(provider.orders![index].id)),
                                DataCell(
                                  Text(
                                    DateFormat("MMM d yyyy HH:mm:00").format(
                                      DateTime.parse(
                                        provider.orders![index].createdDate,
                                      ),
                                    ),
                                  ),
                                ),
                                ...
                                DataCell(
                                  Text(provider.orders![index].orderStatus),
                                ),
                                DataCell(
                                  Row(
                                    children: [
