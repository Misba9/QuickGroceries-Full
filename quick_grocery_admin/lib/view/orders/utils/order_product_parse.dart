...
/// Parses order line snapshots from Firestore (`products` or `items`).
class OrderProductParse {
  ...
  static void debugLogItem(ProductItem p, {int? index}) {
    ...
    debugPrint(
      '${i}unitPrice: ${p.price} totalPrice: ${p.totalPrice} lineTotal: ${p.lineTotal}',
    );
  }
